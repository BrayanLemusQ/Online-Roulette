...
cursor.execute("CREATE TABLE IF NOT EXISTS bets_record (Id int NOT NULL AUTO_INCREMENT, IdUsuario varchar(255) NOT NULL, IdRoulette int NOT NULL, BetSelection varchar(6) NOT NULL, BetAmount smallint NOT NULL, Datetime varchar(30) NOT NULL, BetResult varchar(5) NOT NULL, AmountWon INT NOT NULL, PRIMARY KEY(Id))")
cursor.close()