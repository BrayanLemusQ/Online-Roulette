...
cursor.execute("CREATE TABLE IF NOT EXISTS open_bets (Id int NOT NULL AUTO_INCREMENT, IdUsuario varchar(255) NOT NULL, IdRoulette int NOT NULL, Bet varchar(6) NOT NULL, Datetime varchar(30) NOT NULL, PRIMARY KEY(Id))")
cursor.close()